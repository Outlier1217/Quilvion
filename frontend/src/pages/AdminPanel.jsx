...
const ADMIN_WALLET = "0x33E89cecA902e3FEBf86686A4D0Adb195BA6e49A"; 
    ...
    <div className="admin-container">
      ...
      <div className="space-y-4">
        ...
        {activeTab === 'merchants' && (
          <div>
            {merchants.length === 0 ? (
              <p className="text-xs">No pending merchants</p>
            ) : (
              merchants.map((m, i) => (
                <div key={i} className="bg-white p-4 rounded-lg shadow mb-3">
                  <div className="flex flex-wrap gap-4 items-start justify-between">
                    <div>
                      <p className="font-semibold text-lg">{m[1]}</p>
                      <p className="text-gray-600">{m[2]}</p>
        ...
        {activeTab === 'products' && (
          <div>
            {products.length === 0 ? (
              <p className="text-gray-500 text-center p-8">No pending products</p>
            ) : (
              products.map((p, i) => (
                <div key={i} className="bg-white p-4 rounded-lg shadow mb-3">
                  <div className="flex flex-wrap gap-4 items-start justify-between">
                    <div>
                      <p className="font-semibold text-lg">{p[1]}</p>
                      <p className="text-gray-600 text-sm mb-2">{p[5]}</p>
                      <p className="text-purple-600 font-bold">{p[2]} USDC</p>
                      <p className="text-sm text-gray-500 mt-2">
        ...
        {activeTab === 'escrows' && (
          <div>
            {escrows.length === 0 ? (
              <p className="text-gray-500 text-center p-8">No escrow orders</p>
            ) : (
              escrows.map((o, i) => (
